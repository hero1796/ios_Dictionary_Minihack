...
- (IBAction)btnResetDataClicked:(id)sender {
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:UIAlertViewStyleDefault message:@"Do you want to reset all data ?" delegate:self cancelButtonTitle:@"No" otherButtonTitles:@"Yes", nil];
    [alert show ];
