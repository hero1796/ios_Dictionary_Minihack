...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == 0) {
        ...
        [[SWRevealViewController shareInstance] pushFrontViewController:vc animated:YES];
            ...
            UIAlertView *alert = [[UIAlertView alloc] initWithTitle:UIAlertViewStyleDefault message:@"This is Pashto dictionary application in iOS" delegate:self cancelButtonTitle:@"Ok" otherButtonTitles:nil];
            [alert show ];
